    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl border-2 border-fuchsia-500 dark:border-slate-700 shadow-sm p-6">
      <div className="flex items-center justify-between">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h4 className="text-sm font-bold uppercase tracking-wider text-slate-400">Accesos y Roles (Super Admin)</h4>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
              Controla políticas globales, sesiones, y la administración de permisos (globales vs. por tenant).
            </p>
          </div>
        </div>
        ...
        <button
          type="button"
          onClick={() => {
            // TODO: abrir modal/drawer
            alert("Abrir configuración de seguridad/roles (pendiente).");
          }}
