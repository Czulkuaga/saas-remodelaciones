// src/app/tenant-inactive/page.tsx
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
                Este tenant está suspendido o fue desactivado. Si crees que es un error,
              ...
              <div className="mt-6 rounded-xl border border-slate-200 bg-slate-50/70 p-4 text-xs text-slate-600 dark:border-slate-800 dark:bg-slate-950/40 dark:text-slate-400">
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5">
                  <li>Verifica que el subdominio corresponda a la clínica correcta.</li>
                  <li>Si tu clínica fue suspendida, solicita reactivación al administrador.</li>
                  <li>Si estás en entorno de pruebas, confirma el estado del tenant en la BD.</li>
                </ul>
              </div>
            </div>
          </div>
